        ...
        rows.append(
            {
                ...
                "snapshot_as_of_date": record["snapshot_as_of_date"],
                "observed_at": record["observed_at"],
                "freshness_days": int(record["freshness_days"]),
                "demand_source_artifact": record["source_artifact"],
                "demand_source_sha256": record["source_sha256"],
